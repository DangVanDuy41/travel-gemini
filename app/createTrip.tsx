  ...
  return (
    <SafeAreaView className='flex-1'>
      <View style={{ flex: 1 }}>
        <View >
          {openCard !== 0 && (
            <AnimatedTouchableOpacity style={styles.card}  exiting={FadeOut.duration(200)} className={'flex-row justify-between items-center p-5'} onPress={() => setOpenCard(0)}>
          ...
          {openCard === 0 && (
            ...
            <SearchLocation handleChooseLocation ={handleChooseLocation} />
          )}
        </View>
